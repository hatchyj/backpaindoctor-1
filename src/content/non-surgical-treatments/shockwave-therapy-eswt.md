...
imageAlt: "STORZ Medical focused shockwave (ESWT) applicator"
imageCaption: "We use a STORZ Medical focused shockwave system."
...
evidenceSources:
  - label: "Frontiers in Medicine (2024)"
...
faqs:
  ...
  - question: How many sessions will I need?
    answer: ESWT is usually given as a course of several sessions about a week apart. The number depends on your condition and response, and is planned with you at consultation.
  - question: Is there any downtime?
    answer: Most people have no formal downtime and can return to normal daily activity. We may advise modifying higher-impact or heavy-loading activity for a short period.
  - question: Is it covered by Medicare or private health insurance?
    answer: ESWT for musculoskeletal conditions is generally an out-of-pocket cost and not covered by Medicare. Coverage can change, so we confirm the current position and cost with you beforehand.
  - question: When will I know if it has worked?
    answer: Improvement from ESWT typically develops over several weeks, often continuing after the course of treatment has finished. We arrange review to assess your response.
---
